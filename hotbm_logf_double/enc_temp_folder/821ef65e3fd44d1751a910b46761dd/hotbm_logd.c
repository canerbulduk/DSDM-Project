...
void range_red(unsigned char A, unsigned long long int Y0, unsigned long long int* Zfinal, unsigned long long int* almostLog_H, unsigned long long int* almostLog_L)
{
	...
	static const unsigned long long int logtable6[] = {0 ULL,576460769483293354 ULL,1729382411529111552 ULL,2882304191013932373 ULL,4035226107937788586 ULL,5188148162300712960 ULL,6341070354102738261 ULL,7493992683343897259 ULL,8646915150024222721 ULL,9799837754143747415 ULL,10952760495702504110 ULL,12105683374700525573 ULL,13258606391137844573 ULL,14411529545014493878 ULL,15564452836330506256 ULL,16717376265085914474 ULL};
...
double logd(double x)
{
	...
	//make them all const
	const unsigned char wE = 11;
	const unsigned char wF = 52;
	const unsigned char g = 5;
	const unsigned char a0 = 5;
	const unsigned char log2wF = 6;
	const unsigned char targetprec = 83;
	const unsigned char sfinal = 55;
	const unsigned char pfinal = 28;
	const unsigned long long int log2 = 0b101100010111001000010111111101111101000111001111011110011;
	const unsigned short int E0offset = 0b10000001001;
	const unsigned char pfinal_s = 0b011100;
	const unsigned char lzc_size = 6;
