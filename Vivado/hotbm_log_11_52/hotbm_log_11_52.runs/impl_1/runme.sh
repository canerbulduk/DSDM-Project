...
HD_PWD='C:/Users/caner/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_log_11_52.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fp_log_11_52.tcl -notrace
