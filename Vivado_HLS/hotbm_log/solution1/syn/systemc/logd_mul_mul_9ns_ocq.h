...
// ==============================================================
#ifndef __logd_mul_mul_9ns_ocq__HH__
#define __logd_mul_mul_9ns_ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(logd_mul_mul_9ns_ocq) {
    ...
    SC_CTOR(logd_mul_mul_9ns_ocq):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
