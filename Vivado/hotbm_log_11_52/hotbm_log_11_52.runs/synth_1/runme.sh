...
HD_PWD='C:/Users/caner/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_log_11_52.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_log_11_52.tcl
