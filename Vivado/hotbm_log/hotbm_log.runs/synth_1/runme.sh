...
HD_PWD='C:/Users/caner/OneDrive/Documents/GitHub/DSDM-Project/Vivado/hotbm_log/hotbm_log.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log logd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source logd.tcl
