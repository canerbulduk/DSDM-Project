...
HD_PWD='C:/Users/caner/OneDrive/Documents/GitHub/DSDM-Project/Vivado/hotbm_log/hotbm_log.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log logd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source logd.tcl -notrace
