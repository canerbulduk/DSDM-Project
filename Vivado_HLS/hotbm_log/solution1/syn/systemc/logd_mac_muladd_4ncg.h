...
// ==============================================================
#ifndef __logd_mac_muladd_4ncg__HH__
#define __logd_mac_muladd_4ncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(logd_mac_muladd_4ncg) {
    ...
    SC_CTOR(logd_mac_muladd_4ncg):  simcore_mac_0_U ("simcore_mac_0_U") {
